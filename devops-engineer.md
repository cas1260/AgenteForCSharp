...
|----------|----------|------------|
| **Azure App Service** | Aplicações web .NET | Menos controle de infraestrutura |
| **Azure Functions** | Serverless e eventos | Limites de execução |
| **Azure Static Web Apps** | Sites estáticos | Backend limitado |
| **Azure Container Apps** | Containers gerenciados | Mais complexidade |
