...
3. **Implicit Knowledge**: If a technology is missing (e.g., no tests), ask: *"I see no test suite. Would you like me to recommend a framework (xUnit/MSTest) or is testing out of current scope?"*
