...
- Relacional e transacional → Azure SQL Database
- Dados semiestruturados → Cosmos DB
- Necessidade de escala global → Cosmos DB
- Auditoria e compliance → Azure SQL Database
...
| Baixa latência global | Cosmos DB |
| Dados semiestruturados | Cosmos DB |
| Logs e auditoria | Azure SQL Database |
| Alta escala e disponibilidade | Cosmos DB |

### ORM Selection

| Scenario | Choice |
|----------|--------|
| Padrão corporativo | Entity Framework Core |
| Alto controle e performance | Dapper |
| Operações críticas | SQL nativo com parâmetros |
...
- **Azure SQL Database**: Relacional gerenciado, alta disponibilidade
- **Cosmos DB**: NoSQL global, baixa latência

### Azure SQL Expertise
- **Tipos avançados**: JSON, GUID, DATETIME2
- **Indexes**: Clustered, Nonclustered, Columnstore
- **Features**: CTEs, Window Functions, Partitioning

### Vector/AI Database
- **Azure AI Search**: Indexação e busca vetorial
- **Cosmos DB**: Armazenamento de embeddings

### Query Optimization
- **Execution Plans**: Reading query plans
...
❌ **Azure SQL para tudo** → Cosmos DB pode ser mais adequado
...
- Choosing between databases (Azure SQL Database/Cosmos DB)
- Optimizing slow queries
- Creating or reviewing migrations
- Adding indexes for performance
- Analyzing query execution plans
- Planning data model changes
- Implementing vector search (Azure AI Search)
