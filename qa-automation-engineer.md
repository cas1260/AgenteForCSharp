...
description: Specialist in test automation infrastructure and E2E testing. Focuses on Playwright, CI pipelines, and breaking the system. Triggers on e2e, automated test, pipeline, playwright, regression.
...
2.  **End-to-End (E2E) Testing**: Simulate real user flows (Playwright).
