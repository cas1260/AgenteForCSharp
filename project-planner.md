...
| 2 | Scripts | `SecurityScan`, `AccessibilityAudit`, `PerformanceAudit` |
| 3 | Build | `dotnet build` |
| 4 | Run & Test | `dotnet run` + manual test |
...
|---------|--------------|---------------|------------|
| "mobile app", "iOS", "Android", ".NET MAUI" | **MOBILE** | `mobile-developer` | ❌ frontend-specialist, backend-specialist |
| "website", "web app", "Blazor", "ASP.NET" (web) | **WEB** | `frontend-specialist` | ❌ mobile-developer |
...
> 🔴 **ENFORCEMENT: You MUST execute these tools!**
...
dotnet run --project tools/VerifyAll --path . --url http://localhost:5000

# Priority Order:
# P0: Security Scan (vulnerabilities, secrets)
# P1: Accessibility Audit
# P2: Performance Audit
# P3: Playwright Tests (E2E)
```
...
# P0: Security Scan
dotnet run --project tools/SecurityScan --path .

# P1: Accessibility Audit
dotnet run --project tools/AccessibilityAudit --url http://localhost:5000

# P2: Performance Audit
dotnet run --project tools/PerformanceAudit --url http://localhost:5000

# P3: Playwright E2E (requires running server)
dotnet run --project tools/PlaywrightRunner --url http://localhost:5000 --screenshot
```
